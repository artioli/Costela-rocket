...
import java.awt.BasicStroke; //The BasicStroke class defines a basic set of rendering attributes for the outlines of graphics primitives, which are rendered with a Graphics2D object that has its Stroke attribute set to this BasicStroke.
...
import java.awt.FontMetrics; // The FontMetrics class defines a font metrics object, which encapsulates information about the rendering of a particular font on a particular screen.
import java.awt.Graphics; //The Graphics class is the abstract base class for all graphics contexts that allow an application to draw onto components that are realized on various devices, as well as onto off-screen images
import java.awt.Graphics2D; //This Graphics2D class extends the Graphics class to provide more sophisticated control over geometry, coordinate transformations, color management, and text layout.
import java.awt.Point; // A point representing a location in (x,y) coordinate space, specified in integer precision.
import java.awt.RenderingHints; // The RenderingHints class defines and manages collections of keys and associated values which allow an application to provide input into the choice of algorithms used by other classes which perform rendering and image manipulation services.
import java.awt.Stroke; // The Stroke interface allows a Graphics2D object to obtain a Shape that is the decorated outline, or stylistic representation of the outline, of the specified Shape.
...
public class GraphPanel extends JPanel {
    ...
    static class MainPanel extends JPanel {
        ...
        public MainPanel(List<Double> scores) {
            ...
            JLabel title = new JLabel("Comparação da altura com tempo percorrido pelo foguete");
